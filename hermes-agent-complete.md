...
1. [认识 Hermes Agent](#1-认识-hermes-agent)
   - 1.1 [它是什么](#11-它是什么)
   - 1.2 [为什么会有它](#12-为什么会有它)
   - 1.3 [它能做什么](#13-它能做什么)
   - 1.4 [一个简单的闭环系统](#14-一个简单的闭环系统)
   - 1.5 [它和同类工具的关系](#15-它和同类工具的关系)
2. [整体架构](#2-整体架构)
   - 2.1 [五层模型](#21-五层模型)
   - 2.2 [工具注册机制](#22-工具注册机制)
   - 2.3 [一个请求的完整生命周期](#23-一个请求的完整生命周期)
3. [核心亮点深入](#3-核心亮点深入)
   - 3.1 [闭环学习系统：Agent 如何自己写"外挂"](#31-闭环学习系统agent-如何自己写外挂)
   - 3.2 [记忆设计：三层架构 + FTS5 全文搜索](#32-记忆设计三层架构--fts5-全文搜索)
   - 3.3 [多 Agent 协作](#33-多-agent-协作)
   - 3.4 [子 Agent 的工具隔离](#34-子-agent-的工具隔离)
   - 3.5 [Multi-Agent 设计原则](#35-multi-agent-设计原则)
   - 3.6 [缰绳哲学：Hermes 的设计灵魂](#36-缰绳哲学hermes-的设计灵魂)
4. [快速上手](#4-快速上手)
5. [实践&思考](#5实践思考)
...
#### 1.5.1 Harness Engineering：理解 Hermes 的钥匙
...
#### 3.1.2 Hermes 的解法：Background Review
...
#### 3.1.4 Skill 索引：让大模型从几百个技能里精准选择
