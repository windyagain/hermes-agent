...
flowchart LR
    Q(["用户：帮我部署这个项目"]) --> S1
    S1["FTS5 搜索会话记忆\n找到上次部署时的端口冲突记录"] --> S2
    S2["查持久记忆\n阿里云 ECS · Nginx 反向代理"] --> S3
    S3["加载 deployment-checklist Skill\n按验证过的步骤执行"] --> R(["执行部署"])

    style Q fill:#1a1a2e,stroke:#FFD700,color:#e8e8f0
    style S1 fill:#1a2a3e,stroke:#4a9eff,color:#e8e8f0
    style S2 fill:#1a2a1e,stroke:#4ade80,color:#e8e8f0
    style S3 fill:#2a1a3e,stroke:#7c5cbf,color:#e8e8f0
    style R fill:#1a1a2e,stroke:#FFD700,color:#e8e8f0
```
